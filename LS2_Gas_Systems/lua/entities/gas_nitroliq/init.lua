...
function ENT:Initialize()
	...
	if not (WireAddon == nil) then self.Outputs = Wire_CreateOutputs(self, { "On", "Overdrive", "Energy Consumption", "Nitrogen Consumption", "Coolant Production"}) end
...
function ENT:LiquidateNitro()
    ...
    if not (WireAddon == nil) then
        ...
        Wire_TriggerOutput(self, "Coolant Production", self.coolant)
    end
	...
	if ( self:CanRun() ) then
        ...
        RD_SupplyResource(self, "coolant",self.coolant)
