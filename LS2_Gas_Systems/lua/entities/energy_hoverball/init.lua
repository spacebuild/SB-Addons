...
function ENT:Initialize()
	...
	self.Outputs = Wire_CreateOutputs(self, { "Zpos", "Xpos", "Ypos", "Speed", "Strength", "Resistance", "EnergyConsumption" })
end
...
function ENT:Think()
    ...
    Wire_TriggerOutput(self, "EnergyConsumption", self.energycon)
	return true
end
