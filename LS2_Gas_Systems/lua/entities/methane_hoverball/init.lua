...
function ENT:Initialize()
	...
	self.Outputs = Wire_CreateOutputs(self, { "Zpos", "Xpos", "Ypos", "Speed", "Strength", "Resistance", "MethaneConsumption" })
end
...
function ENT:Think()
    ...
    Wire_TriggerOutput(self, "MethaneConsumption", self.methanecon)
	return true
end
