...
function ENT:Initialize()
    ...
    self:SetColor(Color(85, 0, 0, 255))
	...
	if not (WireAddon == nil) then self.Outputs = Wire_CreateOutputs(self, { "On", "Overdrive", "Propane Consumption", "Energy Production"}) end
...
function ENT:GenerateEnergy()
	...
	if not (WireAddon == nil) then
        ...
        Wire_TriggerOutput(self, "Propane Consumption", self.propane)
    end
