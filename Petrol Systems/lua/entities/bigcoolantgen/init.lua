...
function ENT:Think()
	...
	if (self.toggle == true) then
		...
		self.oil = RD.GetResourceAmount(self, "Oil")
	...
	-- 4 = pertol. 3 = Oil,  2 = 12v
		if(self.petrol > 50 and  self.oil> 30 and self.energy > 2) then
			...
			RD.SupplyResource(self, "liquid nitrogen", Pressure_Increment)
			RD.SupplyResource(self, "carbon dioxide", Pressure_Increment)
