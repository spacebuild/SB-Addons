...
function ENT:Think()
	...
	-- Asign the variables
	self.val2 =	RD.GetResourceAmount(self, "Petrol")
	self.val3 = RD.GetResourceAmount(self, "Oil")
	self.val4 = RD.GetResourceAmount(self, "energy")
	...
	if (self.toggle == true or self.active == 1) then
		...
		if (self.val4 > 70) then
			...
			if (self.val3 > 300) then
				...
				RD.SupplyResource(self, "Petrol", 100)
